...
import { sendDualEmails, fieldRow, summaryTable, detailsBlock, escapeHtml } from "../utils/email";
...
const ContactFormSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const adminBody = `
        <h2 style="color:#820507;font-size:20px;margin:0 0 8px;">New Project Inquiry</h2>
        <p style="color:#6b7280;margin:0 0 20px;">Submitted via the Contact form on techxserve.com</p>
        ${summaryTable(`
          ${fieldRow("Full Name", formData.fullName)}
          ${fieldRow("Email", formData.email)}
          ${fieldRow("Phone", formData.phone)}
          ${fieldRow("Company", formData.company)}
          ${fieldRow("Service Interest", formData.service)}
          ${fieldRow("Project Timeline", formData.timeline)}
          ${fieldRow("Budget Range", formData.budget)}
          ${fieldRow("Source", formData.source)}
        `)}
        ${detailsBlock("Project Details", formData.projectDetails)}
        <p style="color:#6b7280;font-size:13px;margin:24px 0 0;">Reply directly to this email to respond to ${escapeHtml(formData.fullName)}.</p>
      `;

      const customerBody = `
        <h2 style="color:#111827;font-size:22px;margin:0 0 6px;font-weight:700;">Thanks, ${escapeHtml(formData.fullName.split(" ")[0] || "there")}!</h2>
        <p style="color:#6b7280;font-size:15px;margin:0 0 18px;">We've received your project inquiry.</p>
        <p style="color:#374151;margin:0 0 20px;">Our team will review your requirements and get back to you within <strong style="color:#820507;">24 hours</strong>. In the meantime, here's a copy of what you sent us:</p>
        ${summaryTable(`
          ${fieldRow("Service Interest", formData.service)}
          ${fieldRow("Project Timeline", formData.timeline)}
          ${fieldRow("Budget Range", formData.budget)}
          ${fieldRow("Company", formData.company)}
        `)}
        ${detailsBlock("Your Project Details", formData.projectDetails)}
        <p style="color:#374151;margin:28px 0 0;">If you have anything urgent, reach us directly at <a href="mailto:info@techxserve.com" style="color:#820507;text-decoration:none;font-weight:500;">info@techxserve.com</a> or <a href="tel:+13072939151" style="color:#820507;text-decoration:none;font-weight:500;">+1 (307) 293-9151</a>.</p>
        <p style="color:#374151;margin:18px 0 0;">Talk soon,<br><strong>The TechxServe Enterprise Team</strong></p>
      `;

      await sendDualEmails({
        adminSubject: `New Project Inquiry from ${formData.fullName}`,
        adminBodyHtml: adminBody,
        customerEmail: formData.email,
        customerSubject: "We received your inquiry — TechxServe Enterprise",
        customerBodyHtml: customerBody,
      });

      setSubmitStatus({ type: "success", message: "Message sent! Check your inbox — we'll get back to you within 24 hours." });
      setFormData({
        fullName: "",
        email: "",
        phone: "",
            ...
            <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-gray-200/50 p-8 lg:p-12 group-hover:shadow-2xl transition-all duration-500">
              ...
              >
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="service" className="flex items-center text-gray-700">
                    ...
                    <NativeSelect
                      ...
                      options={[
                        ...
                        { value: "SaaS Platform Development", label: "SaaS Platform Development" },
                        { value: "Mobile App Development", label: "Mobile App Development" },
                        { value: "Automation Solutions", label: "Automation Solutions" },
                        { value: "Data Analytics & Dashboards", label: "Data Analytics & Dashboards" },
                        ...
                        { value: "Branding & Visual Identity", label: "Branding & Visual Identity" },
                        { value: "Digital Marketing & SEO", label: "Digital Marketing & SEO" },
                        { value: "IT Consulting & Strategy", label: "IT Consulting & Strategy" },
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="timeline" className="flex items-center text-gray-700">
                    ...
                    <NativeSelect
                      ...
                      options={[
                        ...
                        { value: "Ongoing / Long-Term Partnership", label: "Ongoing / Long-Term Partnership" },
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="budget" className="flex items-center text-gray-700">
                ...
                <div className="space-y-2">
                  <Label htmlFor="source" className="flex items-center text-gray-700">
                  ...
                  <NativeSelect
                    ...
                    options={[
                      { value: "Google / Bing Search", label: "Google / Bing Search" },
                      { value: "LinkedIn", label: "LinkedIn" },
                      { value: "Facebook / Instagram", label: "Facebook / Instagram" },
                      { value: "Referral from a Friend / Colleague", label: "Referral from a Friend / Colleague" },
                      { value: "Referred by an Existing Client", label: "Referred by an Existing Client" },
                      { value: "Conference / Event / Webinar", label: "Conference / Event / Webinar" },
                      { value: "Press / News Article", label: "Press / News Article" },
                      { value: "Online Directory (Clutch, G2, etc.)", label: "Online Directory (Clutch, G2, etc.)" },
                ...
                {submitStatus && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className={`text-center pt-4 ${submitStatus.type === "success" ? "text-green-600" : "text-red-600"}`}
                  >
