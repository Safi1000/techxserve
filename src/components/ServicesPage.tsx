  ...
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="container mx-auto px-6 relative z-10 pt-24 pb-12">
      <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
        ...
        >
          <div className="relative w-full h-[220px] sm:h-[320px] md:h-[400px] lg:h-[500px] rounded-2xl overflow-hidden shadow-xl group-hover:shadow-2xl transition-all duration-700">
            <ImageWithFallback
...
const ServicesOverviewSection = ({ onServiceSelect, selectedService, expandedService, setExpandedService, detailsRef }: { onServiceSelect: (id: string) => void; selectedService: string | null; expandedService: string | null; setExpandedService: (id: string | null) => void; detailsRef: RefObject<HTMLDivElement | null> }) => {
  const services = [
    {
      id: "website",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-8 max-w-7xl mx-auto">
          {services.map((service, index) => (
            ...
            >
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-gray-200/50 relative overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-4 min-h-[280px] md:h-[350px] flex flex-col justify-between">
...
const DetailedServiceSection = ({ serviceId, isExpanded, detailsRef }: { serviceId: string; isExpanded: boolean; detailsRef: RefObject<HTMLDivElement | null> }) => {
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
              ...
              <motion.div
                ...
                className="relative group"
              >
                <div className="relative w-full h-[260px] sm:h-[380px] md:h-[500px] rounded-3xl overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-700">
                  <ImageWithFallback
                    src={service.image}
                    alt={service.title}
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--brand-primary)] to-red-600">TechxServe Enterprise</span>
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-[var(--brand-primary)] to-red-500 mx-auto rounded-full animate-shimmer" />
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mt-8 leading-relaxed">
