      ...
      <div className="container mx-auto px-6 text-center z-30 relative min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <motion.div
            ...
            className="mt-20"
          >
            <p className="text-xs md:text-sm uppercase tracking-[0.2em] text-gray-500 mb-6 font-medium">
              Company's TechxServe Enterprise LLC is Affiliated With
            </p>
            <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 md:gap-x-16">
              {["SIXTHLEDGER", "HUEBRICKS", "TECHXSERVE", "LUNARIS MEDIA"].map((name, i) => (
                <motion.span
                  key={name}
                  className="text-base md:text-lg font-semibold tracking-wider text-gray-700 hover:text-[var(--brand-primary)] transition-colors duration-300 cursor-default"
