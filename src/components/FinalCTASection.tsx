        ...
        >
          ...
          >
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-2 border-white text-white hover:bg-white hover:text-[var(--brand-primary)] px-8 py-4 text-lg rounded-full font-medium transition-all duration-300 transform hover:scale-105"
            >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center text-white/90">
              <a href="mailto:info@techxserve.com" className="hover:text-white transition-colors duration-300">
                info@techxserve.com
              </a>
              <div className="hidden sm:block w-1 h-1 bg-white/50 rounded-full"></div>
              <a href="tel:+13072939151" className="hover:text-white transition-colors duration-300">
                +1 (307) 293-9151
              </a>
            </div>
          </motion.div>
