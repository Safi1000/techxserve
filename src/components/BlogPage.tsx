...
const FeaturedPostSection = ({ post }: { post: BlogPost }) => (
...
// Categories Section
const CategoriesSection = ({ selectedCategory, onCategorySelect }: { selectedCategory: string; onCategorySelect: (cat: string) => void }) => (
  <section className="py-16 relative overflow-hidden">
    {/* Background */}
    <EnhancedBackgroundAnimation intensity="subtle" theme="mixed" />
    <div className="absolute inset-0 bg-gradient-to-br from-gray-50/90 via-white/95 to-gray-50/90" />
...
// Blog Posts Grid
const BlogPostsGrid = ({ posts, layout = "grid" }: { posts: BlogPost[]; layout?: string }) => (
  <section className="py-16 relative overflow-hidden">
    {/* Background */}
    <EnhancedBackgroundAnimation intensity="subtle" theme="mixed" />
    <div className="absolute inset-0 bg-gradient-to-br from-gray-50/90 via-white/95 to-gray-50/90" />
...
// Sidebar Component
const BlogSidebar = ({ selectedCategory, onCategorySelect }: { selectedCategory: string; onCategorySelect: (cat: string) => void }) => (
