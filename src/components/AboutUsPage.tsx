...
const SubtleGeometricBackground = ({ className = "" }: { className?: string }) => {
  return (
  ...
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="container mx-auto px-6 relative z-10 pt-20">
      <div className="grid lg:grid-cols-5 gap-16 items-center">
        ...
        >
          ...
          >
            <div className="inline-flex items-center px-5 py-2 bg-gradient-to-r from-[var(--brand-primary)]/8 to-purple-500/8 text-[var(--brand-primary)] rounded-full mb-8 backdrop-blur-sm border border-[var(--brand-primary)]/15 transition-all duration-500 hover:scale-105">
              ...
              <span className="font-medium">About TechxServe Enterprise</span>
            </div>
        ...
        >
          <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] rounded-3xl overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-700">
            <ImageWithFallback
    ...
    <div className="container mx-auto px-6 relative z-10">
      ...
      <div className="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="relative group"
        >
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-gray-200/50 relative overflow-hidden transition-all duration-500 hover:shadow-3xl hover:-translate-y-2 hover:scale-105 min-h-[320px] md:h-[400px] flex flex-col justify-between">
            {/* Animated border */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {values.map((value, index) => (
            ...
            >
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-gray-200/50 relative overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-4 min-h-[250px] md:h-[300px] flex flex-col justify-between">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          {approaches.map((approach, index) => (
            <motion.div
              ...
              className="relative group"
            >
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-10 shadow-xl border border-gray-200/50 relative overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-4 min-h-[300px] md:h-auto flex flex-col justify-between">
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-gradient-to-br from-gray-50 to-white">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <div className="relative w-full h-[280px] sm:h-[380px] md:h-[500px] bg-white rounded-3xl overflow-hidden shadow-2xl border border-gray-200">
